(function registerExtendedIndustrializationElectricFarmer() {
    var CONTROLLER_ID =
        'extended_industrialization:electric_farmer';

    var STRUCTURE_PREFIX =
        'example:electric_farmer_';
    ...
    var HATCH_CASING_ID =
        'extended_industrialization:steel_pipe';
    ...
    var VARIANTS = [
        ...
        },
        {
            ...
            variantId:
                'mi_multiblock_editor:farmer_large',
        ...
        },
        {
            ...
            variantId:
                'mi_multiblock_editor:farmer_extreme',
